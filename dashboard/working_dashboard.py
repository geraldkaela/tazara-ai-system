"""
Final Working TAZARA Multi-Route Dashboard
Works without database dependencies and provides full functionality
"""
...
def main():
    st.set_page_config(
        page_title="🚂 TAZARA Multi-Route Operations Dashboard",
        page_icon="🚂",
        layout="wide",
    ...
    with st.sidebar:
        ...
        with col1:
            ...
            dar_kapiri = st.number_input("DAR_KAPIRI (tons)", min_value=0, value=1000)
            dar_mbeya = st.number_input("DAR_MBEYA (tons)", min_value=0, value=1000)
